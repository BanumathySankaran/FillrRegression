...
public class ReadRegistry {
  ...
  private static Class<? extends Preferences> userClass = (Class<? extends Preferences>)userRoot.getClass();
  ...
  public static String getDecryptedStr(String encryptedCode) {
    String key = null;
    try {
      key = readString(-2147483647, "SOFTWARE\\CraftWork", "PassKey");
